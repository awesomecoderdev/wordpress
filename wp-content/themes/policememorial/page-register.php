...
<main id="main" class="<?php echo lumi_container("py-10 not-prose"); ?>">
    ...
    <div class="relative grid xl:grid-cols-10 md:grid-cols-10 gap-10">
        ...
        <div class="relative md:col-span-5  col-span-1 space-y-5">
            <h1 class="text-3xl font-semibold"><?php _e("Create an account", "lumi") ?></h1>
            <form id="login-form" action="javascript:void(0)" method="POST" class="relative space-y-3 max-w-sm">
                <div class="relative grid grid-cols-2 gap-3">
                    <div class="relative">
                        <label for="first_name"><?php _e("First Name", "lumi") ?></label>
                        <div class="relative border border-primary-50 rounded-lg">
                            <div class="absolute pointer-events-none z-50 left-2 top-1/2 transform translate-y-[-50%] w-20">
                                <div class="relative h-full w-full flex items-center text-primary-500 space-x-2">
                                    <svg class="h-6 w-6" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16.1246 6.78411C15.9408 9.27493 14.0621 11.3069 11.9995 11.3069C9.93705 11.3069 8.05502 9.2754 7.87455 6.78411C7.68705 4.19295 9.51517 2.26135 11.9995 2.26135C14.4839 2.26135 16.3121 4.24006 16.1246 6.78411Z" stroke="#575757" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12.0001 14.322C7.92199 14.322 3.78293 16.5834 3.01699 20.8518C2.92465 21.3662 3.21433 21.86 3.75011 21.86H20.2501C20.7864 21.86 21.0761 21.3662 20.9837 20.8518C20.2173 16.5834 16.0782 14.322 12.0001 14.322Z" stroke="#575757" stroke-miterlimit="10" />
                                    </svg>
                            ...
                            <input class="relative pl-14 text-sm placeholder:text-sm bg-transparent outline-none border-none border-transparent outline-transparent focus:outline-none focus-visible:outline-none focus:ring-transparent w-full" type="password" name="first_name" id="first_name" placeholder="<?php _e('First Name', 'lumi') ?>">
                        </div>
                    </div>
                    <div class="relative">
                        <label for="last_name"><?php _e("Last Name", "lumi") ?></label>
                        <div class="relative border border-primary-50 rounded-lg">
                            <div class="absolute pointer-events-none z-50 left-2 top-1/2 transform translate-y-[-50%] w-20">
                                <div class="relative h-full w-full flex items-center text-primary-500 space-x-2">
                                    <svg class="h-6 w-6" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="relative pl-14 text-sm placeholder:text-sm bg-transparent outline-none border-none border-transparent outline-transparent focus:outline-none focus-visible:outline-none focus:ring-transparent w-full" type="password" name="last_name" id="last_name" placeholder="<?php _e("Last Name", "lumi") ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="relative grid grid-cols-2 gap-3">
                    <div class="relative">
                        ...
                        <div class="relative border border-primary-50 rounded-lg">
                            ...
                            <input class="relative pl-14 pr-9 text-sm placeholder:text-sm bg-transparent outline-none border-none border-transparent outline-transparent focus:outline-none focus-visible:outline-none focus:ring-transparent w-full" type="password" name="password" id="password" placeholder="Password">
                    ...
                    <div class="relative">
                        <label for="confirm_password"><?php _e("Confirm password", "lumi") ?></label>
                        <div class="relative border border-primary-50 rounded-lg">
                            <div class="absolute pointer-events-none z-50 left-2 top-1/2 transform translate-y-[-50%] w-20">
                                <div class="relative h-full w-full flex items-center text-primary-500 space-x-2">
                                    <svg class="h-6 w-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="relative pl-14 pr-9 text-sm placeholder:text-sm bg-transparent outline-none border-none border-transparent outline-transparent focus:outline-none focus-visible:outline-none focus:ring-transparent w-full" type="password" name="confirm_password" id="confirm_password" placeholder="Confirmed">

                            <svg id="confirmed-password-show" class="hidden confirmed-password-integrator absolute text-slate-500 cursor-pointer right-2 top-1/2 transform translate-y-[-50%] w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <svg id="confirmed-password-hidden" class="confirmed-password-integrator absolute text-slate-500 cursor-pointer right-2 top-1/2 transform translate-y-[-50%] w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                            </svg>
                        </div>
                    </div>
                ...
                <div class="relative w-full">
                    <button class="mx-auto block bg-primary-500 text-white w-full rounded-md overflow-hidden py-1" type="submit"><?php _e("Sign up", "lumi") ?></button>
