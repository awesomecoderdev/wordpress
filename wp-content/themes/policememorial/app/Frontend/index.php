        ...
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) :
                ...
                <div class="about__container bd-grid">
                    ...
                    <img src="<?php echo (!empty(get_the_post_thumbnail_url())) ? get_the_post_thumbnail_url() : AC_RESTAURANT_THEME_URL . "assets/img/undraw_eating_together_tjhx.svg"; ?>" alt="" class="about__img">
                </div>
                <br>
                <br>
        ...
        <?php else : ?>
            <div class="bd-container">
                <section class="page_404">
                    ...
                    <br>
                    <br>
                    <img src="<?php echo AC_RESTAURANT_THEME_URL . "assets/img/404.svg"; ?>" alt="">
                    <br>
                    <br>
    ...
    <section class="home" id="home">
        <div class="home__container bd-container bd-grid">
            <div class="home__data">
                <h1 class="home__title"><?php bloginfo("title"); ?></h1>
                <h2 class="home__subtitle"><?php bloginfo("description"); ?></h2>
                <a href="#menu" class="button">View Menu</a>
            </div>

            <img src="<?php echo AC_RESTAURANT_THEME_URL; ?>assets/img/home.png" alt="" class="home__img">
        </div>

        <!-- <div class="ajaxcartdiv"></div> -->
    </section>
            ...
            <?php foreach ($products as $product) : ?>
                ...
                <div class="menu__content">
                    ...
                    <a href="<?php echo get_permalink($productid); ?>">
                        ...
                        <h3 class="menu__name"><?php echo $product->get_name(); ?></h3>
                        ...
                        <span class="menu__preci"><?php echo $product->get_price_html(); ?></span>
                        <span data-product_id="<?php echo $productid; ?>" id="product_id_<?php echo $productid; ?>" data-quantity="1" data-product_sku="<?php echo $product->get_sku(); ?>" class="button menu__button restaurant_cart_btn"><i class='bx bx-cart-alt'></i></span>
                    </a>
        ...
        <div class="app__container bd-grid">
            <div class="app__data">
                ...
                <div class="app__stores">
                    <a href="#"><img src="<?php echo AC_RESTAURANT_THEME_URL; ?>assets/img/app1.png" alt="" class="app__store"></a>
                    <a href="#"><img src="<?php echo AC_RESTAURANT_THEME_URL; ?>assets/img/app2.png" alt="" class="app__store"></a>
                </div>
            </div>

            <img src="<?php echo AC_RESTAURANT_THEME_URL; ?>assets/img/movil-app.png" alt="" class="app__img">
        </div>
    </section>
            ...
            function scrollActive() {
                ...
                sections.forEach(current => {
                    ...
                    if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
                        $('.nav__menu a[href*=' + sectionId + ']').closest("li").addClass('active-link');
                    } else {
                        $('.nav__menu a[href*=' + sectionId + ']').closest("li").removeClass('active-link');
                    }
                })
            }
...
<li class="nav__item"><i class='bx bx-cart-alt cartCountBox'><span id="cartCount"><?php echo WC()->cart->get_cart_contents_count(); ?></span></i></li>